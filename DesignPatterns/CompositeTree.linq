...
{
	private Components children = new();
...
public class Leaf : Component
{
	...
	public override void Add(Component c) => "Cannot add to a leaf".Dump("Leaf");

	public override void Remove(Component c) => "Cannot remove from a leaf".Dump("Leaf");

	public override void Show(int depth) => string.Concat(new string('-', depth), name).Dump("Leaf");
